...
A revamp from the traditional Sports Day, the sports carnival was created to maximise participation. Different levels will assigned to different sports and Lasallians compete by houses. Games learning starts from their PE lessons and continue on to the house practices before the actual day.
...
Primary 1 and Primary 2 will have different relay games were created based on what they have learnt in the lower primary PE syllabus. They are then assigned to one game per house and compete against the same houses from the other classes in the same level.
